...
**⚠️ Important:** After your FIRST successful publish, you must save the generated DID as a secret.

1. Go to the **Actions** tab in your repository
2. Click on the latest **"Publish to FAIR Repository"** workflow run
3. Expand the **"Create or update PLC DID"** step
4. Look for the output showing your DID (format: `did:plc:...`)
5. Copy the DID value
6. Add it as a repository secret:
...
**Why?** This DID identifies your plugin in the FAIR protocol. Saving it as a secret allows future releases to use the same identity instead of creating a new DID each time.
...
| `FAIR_DID` | Your package's DID identifier | Generated by first workflow run, **you must add manually** (see Step 6) |
